...
import { Pressable, StyleSheet, TextInput, View, Text, ScrollView, SafeAreaView, KeyboardAvoidingView, Platform } from 'react-native'
...
export default function Page() {
 ...
 const handleSubmit = async () => {
  ...
  console.log('After signIn.password, status:', signIn.status)
  console.log('supportedSecondFactors:', signIn.supportedSecondFactors)
  ...
  if (signIn.status === 'complete') {
    // normal case: no second factor needed
  ...
  router.push(url as Href)
    ...
    // second factor is required: send email code
    ...
    if (emailCodeFactor) {
      ...
      console.log('Second-factor email code sent')
    } else {
      console.error('No email_code factor found for second factor', signIn.supportedSecondFactors)
    }
  } else {
...
////Show this screen if otp verification is needed
                    ...
                    <View className="auth-content">
                        ...
                        <View className="auth-brand-block">
                            <View className="auth-logo-wrap">
                                ...
                                <View>
                                    <Text className="auth-wordmark">HandleSub</Text>
                                    <Text className="auth-wordmark-sub">SUBSCRIPTIONS</Text>
                                </View>
                            </View>
